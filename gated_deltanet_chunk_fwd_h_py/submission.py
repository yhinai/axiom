...
_TINY = helion.Config(block_sizes=[], indexing=['tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer', 'pointer', 'pointer'], l2_groupings=[32], load_eviction_policies=['first', 'first', 'last', '', 'first'], loop_orders=[[1, 0]], maxnreg=64, num_sm_multiplier=4, num_stages=3, num_warps=16, pid_type='persistent_blocked', range_flattens=[True, False], range_multi_buffers=[False, True], range_num_stages=[1, 4], range_unroll_factors=[0, 1], range_warp_specializes=[True, None], static_ranges=[False])
