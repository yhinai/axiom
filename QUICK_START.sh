...
echo "python eval.py test fp8_quant_py/"
...
echo ""
echo "# Benchmark:"
echo "python eval.py benchmark fp8_quant_py/"
...
echo "popcorn submit fp8_quant_py/submission.py --gpu B200_Nebius --leaderboard fp8_quant --mode test"
